class TransportadorasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @transportadora.save
        format.html { redirect_to transportadora_url(@transportadora), notice: 'Transportadora was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @transportadora.update(transportadora_params)
        format.html { redirect_to transportadora_url(@transportadora), notice: "Transportadora was successfully updated." }
  ...
  private
    ...
    def transportadora_params
      params.require(:transportadora).permit(:nome, :telefone, :cnpj, endereco_attributes: [:cep, :logradouro, :numero, :complemento, :cidade, :bairro, :pais, :codigo_postal])
    end
end
