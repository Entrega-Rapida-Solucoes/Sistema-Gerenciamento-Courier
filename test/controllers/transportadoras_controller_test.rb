...
class TransportadorasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transportadora" do
    assert_difference("Transportadora.count") do
      post transportadoras_url, params: { transportadora: { cnpj: @transportadora.cnpj, endereco_id: @transportadora.endereco_id, nome: @transportadora.nome, telefone: @transportadora.telefone } }
    end
  ...
  test "should update transportadora" do
    patch transportadora_url(@transportadora), params: { transportadora: { cnpj: @transportadora.cnpj, endereco_id: @transportadora.endereco_id, nome: @transportadora.nome, telefone: @transportadora.telefone } }
